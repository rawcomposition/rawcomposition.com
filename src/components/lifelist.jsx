...
function Lifelist({total, initialItems}) {
	const [allSpecies, setAllSpecies] = useState(initialItems);
	const [species, setSpecies] = useState(initialItems);
		...
		<div className="container page-wrapper">
			<div className="page content lifelist">
				...
				<div className="actions">
					<span className="species-total">Total species: {total}</span>
					<div>
