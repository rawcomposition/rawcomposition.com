	...
	return (
		<div className='sidebar'>
			<div className='bio'>
				...
				<div>
					<h4>Adam Jackson</h4>
					<p>I'm a birder and bird photographer. I was first introduced to bird photography at the age of 12 while living in Tasmania.I started getting more serious about birding in 2016.</p>
				</div>
			</div>
			<h4>Elsewhere</h4>
